  ...
  return (
    <div className="container-fluid">
      ...
      {(()=>{ 
        ...
        return (
        <>
          <TickersTable items={filtered} onDelete={onDeleteTicker} onOpenInvest={onOpenInvest} onOpenDetail={(it)=>setDetailId(it.id)} onUpdatePrice={onUpdatePrice} onEdit={onEditTickerOpen} refreshingMap={refreshingMap} />
